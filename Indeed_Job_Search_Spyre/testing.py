...
class StocksWithBokeh(server.App):
    ...
    def getData(self, params):
        ...
        data = json.loads(result.decode('utf-8').replace('finance_charts_json_callback( ', '')[
                          :-1])  # strip away the javascript and load json
    ...
    def getHTML(self, params):
        ...
        try:
            bokeh_plot = plotting.line(df['Date'], df['close'], color='#1c2980', legend="close", x_axis_type="datetime",
